...
def main():
    ...
    startup_lines = [
        ...
        f"  Head architecture: BN->Drop(0.5)->Linear(256)->GELU->Drop(0.4)->Linear(2)",
        "=" * 70,
    ]
    ...
    if args.resume and os.path.exists(args.resume):
        ...
        if "epoch" in checkpoint:
            ...
            if resumed_epoch >= 31:
                ...
                logger.info(f"Resume: aligned to Phase 1 (partial unfreeze)")
            else:
    ...
    def run_epoch(epoch):
        ...
        if epoch == 6:
            ...
            logger.info(f"Phase 1: partial unfreeze — backbone LR set to "
            ...
            logger.info(f"Phase 2: full unfreeze — backbone LR set to "
