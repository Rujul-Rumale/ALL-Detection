    ...
    \textbf{Our Baseline (Fold 1)} & 96.12\% & 83.38\% & \textbf{Yes} \\ 
    \textbf{Our Hybrid (Fold 1)} & \textbf{96.64\%} & 82.19\% & \textbf{Yes} \\ \bottomrule
    ...
    %   figures/comparison_loss_curves.png    -- train/val loss vs epoch
    %   figures/comparison_auc_curve.png      -- AUC-ROC vs epoch with best checkpoint marker
    %   figures/comparison_confusion_matrices.png -- dual matrices 
    % All figures: png format for seamless pdflatex compiling in Overleaf.
